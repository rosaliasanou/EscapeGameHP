...
function checkAnswer() {
    ...
    if (userAnswer === Citation.answer) {
        resultatDiv.innerHTML = " Bravo! Tu es un vrai sorcier! C'est important de bien retenir ce sortilège, On ne sait jamais quand on en aura besoin... " + "<a href='pendu.html'>Clique ici pour continuer!</a>";
        disableGame();}
      else {
        attempts++;
...
function checkQCM() {
  ...
  if (selected === Citation.answer) {
      resultatDiv.innerHTML = "Correct! C'est important de bien retenir ce sortilège, On ne sait jamais quand on en aura besoin... " + "<a href='pendu.html'>Clique ici pour continuer!</a>";}
    
    else {resultatDiv.innerHTML =
          `Faux! La réponse était "${Citation.answer}". C'est important de bien retenir ce sortilège, On ne sait jamais quand on en aura besoin...` +  "<a href='pendu4.html'>Clique ici pour continuer!</a>";}
